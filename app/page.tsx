  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#FBF7EC] text-[#10201A] overflow-x-hidden font-sans">
        ...
        {/* Hero Section */}
        <section className="relative bg-[radial-gradient(120%_100%_at_50%_-10%,#16332A_0%,#0A1512_55%)] text-white pt-16 sm:pt-20 pb-16 px-4 sm:px-8 overflow-hidden">
          <div className="absolute w-[520px] h-[520px] rounded-full bg-[#17C97F] opacity-20 -top-40 -left-[140px] blur-[110px] pointer-events-none animate-drift1" />
          <div className="absolute w-[420px] h-[420px] rounded-full bg-[#FF6A4D] opacity-15 top-[60px] -right-[140px] blur-[110px] pointer-events-none animate-drift2" />

          <div className="max-w-[1180px] mx-auto grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-12 lg:gap-16 items-center relative z-10">
            {/* Left Copy */}
            <div>
              <div className="inline-flex items-center gap-2 font-mono text-xs uppercase tracking-wider font-semibold text-[#7DE8B8] bg-[#17C97F]/10 border border-[#17C97F]/25 px-3.5 py-1.5 rounded-full mb-5">
                <span className="w-2 h-2 rounded-full bg-[#17C97F] animate-pulse-dot" />
                <span>Vet-Trained AI on Call 24/7</span>
              </div>

              <h1 className="text-4xl sm:text-5xl lg:text-[54px] font-display font-extrabold leading-[1.08] tracking-tight mb-5 text-white">
              ...
              <p className="text-[#9AB0A5] text-base sm:text-lg leading-relaxed max-w-[500px] mb-8">
              ...
              <div className="flex flex-wrap items-center gap-3.5 mb-10">
                <a
                  href="#pricing"
                  className="px-7 py-3.5 rounded-full font-bold text-sm text-white bg-gradient-to-br from-[#FF6A4D] to-[#E24E30] shadow-[0_8px_20px_rgba(255,106,77,0.35)] hover:-translate-y-0.5 hover:shadow-[0_12px_26px_rgba(255,106,77,0.45)] transition-all flex items-center gap-2"
                >
                ...
                <a
                  href="#how"
                  className="px-6 py-3.5 rounded-full font-semibold text-sm text-[#EAF3ED] bg-white/[0.06] border border-white/10 hover:bg-white/10 transition-all"
                >
                  See How It Works
                </a>
              </div>
              ...
              {/* Proof badges */}
              <div className="grid grid-cols-3 gap-4 pt-6 border-t border-white/10 text-xs sm:text-sm text-[#9AB0A5]">
                <div>
                  <b className="block text-xl sm:text-2xl font-bold text-white mb-0.5 font-display">24/7</b>
                  <span>Real-time availability</span>
                </div>
                <div>
                  <b className="block text-xl sm:text-2xl font-bold text-white mb-0.5 font-display">DVM</b>
                  <span>Practicing vet-trained</span>
                </div>
                <div>
                  <b className="block text-xl sm:text-2xl font-bold text-white mb-0.5 font-display">Live Voice</b>
                  <span>Conversational audio</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="bg-[linear-gradient(165deg,#0F241D,#0A1712)] border border-[#7DE8B8]/20 rounded-[28px] p-5 sm:p-6 shadow-[0_30px_80px_-28px_rgba(6,14,11,0.5),0_0_60px_-10px_rgba(23,201,127,0.2)]">
                {/* Console Top */}
                <div className="flex items-center justify-between mb-4 px-1 pb-3 border-b border-white/[0.08]">
                  ...
                  <span className="text-[11px] font-mono text-[#7DE8B8] bg-[#17C97F]/10 px-2 py-0.5 rounded-md border border-[#17C97F]/20">
                    Active
                  </span>
                </div>

                {/* Console Messages Box */}
                <div className="bg-[#081711] rounded-2xl p-4 min-h-[290px] max-h-[340px] overflow-y-auto flex flex-col gap-3 border border-white/[0.04] custom-scroll text-xs sm:text-sm">
                  {visibleBubbles.map((b, i) => (
                    <div
                      key={i}
                      className={`max-w-[86%] px-4 py-2.5 rounded-2xl leading-relaxed animate-modal-in ${
                        b.who === "user"
                    ...
                    >
                      {b.tag && (
                        <span className="block font-mono text-[10px] text-[#0E9C63] uppercase tracking-wider font-semibold mb-0.5">
                          {b.tag}
                        </span>
                      )}
                      <p>{b.text}</p>
                ...
                <div className="mt-3.5 pt-1">
                  <svg viewBox="0 0 340 32" className="w-full h-7">
                    <path
                ...
                <div className="flex items-center gap-2.5 mt-3">
                  <div className="flex-1 bg-[#081711] border border-[#1E3D32] rounded-full px-4 py-2.5 text-[#7C9689] text-xs font-sans">
                    Kora is listening...
                  </div>
                  <button
                    type="button"
                    onClick={triggerLiveVoice}
                    className="w-10 h-10 rounded-full bg-[#17C97F]/15 border border-[#17C97F]/30 flex items-center justify-center flex-shrink-0 cursor-pointer hover:bg-[#17C97F] text-[#7DE8B8] hover:text-[#06180F] transition-all"
                    title="Speak to Kora"
                  >
        ...
        <section className="bg-[#132A22] border-y border-white/[0.08] text-white py-7 px-4 sm:px-8">
          <div className="max-w-[1180px] mx-auto grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="border-l-2 border-[#17C97F]/50 pl-4">
              <b className="text-2xl sm:text-3xl font-display font-bold bg-[linear-gradient(100deg,#fff,#9AE8C6)] bg-clip-text text-transparent block">
                7+ Years
              </b>
              <span className="text-xs font-mono uppercase tracking-wider text-[#9AB0A5]">
                Clinical Experience
              </span>
            </div>
        ...
        {/* Mission Section */}
        <section className="py-20 sm:py-24 px-4 sm:px-8 bg-[#FBF7EC]" id="mission">
          <div className="max-w-[1180px] mx-auto grid grid-cols-1 lg:grid-cols-[0.95fr_1.05fr] gap-12 lg:gap-16 items-center">
            <div className="relative">
              <img
                ...
                className="rounded-3xl w-full h-[380px] sm:h-[450px] object-cover shadow-xl border border-[#E6DDC0]"
              />
              <div className="absolute -bottom-5 -right-3 sm:-right-5 bg-white border border-[#E6DDC0] rounded-2xl p-4 shadow-xl max-w-[240px]">
                <span className="font-mono text-[11px] uppercase tracking-wider text-[#0E9C63] font-bold block mb-1">
                  Our Mission
                </span>
                <p className="text-xs text-[#4C5C53] leading-relaxed">
            ...
            <div>
              <span className="inline-flex items-center gap-2 font-mono text-xs uppercase tracking-wider font-semibold text-[#0E9C63] mb-3">
                <span className="w-2 h-2 rounded-full bg-[#17C97F]" />
                <span>Built by a Vet, Designed for Pet Parents</span>
              </span>

              <h2 className="text-3xl sm:text-4xl font-display font-extrabold text-[#10201A] tracking-tight mb-5 leading-tight">
                The precision of AI, with the heart of a real veterinarian.
              </h2>

              <div className="space-y-4 text-sm sm:text-base text-[#4C5C53] leading-relaxed mb-8">
                <p>
              ...
              <a
                href="#pricing"
                className="inline-flex items-center gap-2 px-6 py-3.5 rounded-full font-bold text-sm text-[#06180F] bg-gradient-to-br from-[#17C97F] to-[#0E9C63] shadow-[0_6px_20px_rgba(23,201,127,0.3)] hover:-translate-y-0.5 transition-all"
              >
        ...
        <section className="py-20 sm:py-24 px-4 sm:px-8 bg-[#F2EAD3]/40 border-y border-[#E6DDC0]/70" id="how">
          <div className="max-w-[1180px] mx-auto">
            <div className="max-w-[620px] mb-12">
              ...
              <h2 className="text-3xl sm:text-4xl font-display font-extrabold text-[#10201A] tracking-tight">
                From symptom to a clear plan in three simple steps.
              </h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white border border-[#E6DDC0] rounded-3xl p-7 shadow-xs hover:-translate-y-1 hover:border-[#17C97F] transition-all">
                <span className="font-mono text-xs text-[#E24E30] bg-[#FFE8DF] font-bold px-3 py-1 rounded-full inline-block mb-4">
                  01
                </span>
                <h3 className="text-lg font-bold text-[#10201A] mb-2">Describe the Symptom</h3>
              ...
              <div className="bg-white border border-[#E6DDC0] rounded-3xl p-7 shadow-xs hover:-translate-y-1 hover:border-[#17C97F] transition-all">
                <span className="font-mono text-xs text-[#0E9C63] bg-[#DDF7E9] font-bold px-3 py-1 rounded-full inline-block mb-4">
                  02
                </span>
                <h3 className="text-lg font-bold text-[#10201A] mb-2">Clinical Veterinary Triage</h3>
                <p className="text-xs sm:text-sm text-[#4C5C53] leading-relaxed">
              ...
              <div className="bg-white border border-[#E6DDC0] rounded-3xl p-7 shadow-xs hover:-translate-y-1 hover:border-[#17C97F] transition-all">
                <span className="font-mono text-xs text-[#F4B740] bg-amber-100 font-bold px-3 py-1 rounded-full inline-block mb-4">
                  03
                </span>
                <h3 className="text-lg font-bold text-[#10201A] mb-2">Actionable Next Steps</h3>
                <p className="text-xs sm:text-sm text-[#4C5C53] leading-relaxed">
        ...
        {/* Features Section */}
        <section className="py-20 sm:py-24 px-4 sm:px-8 bg-[#0A1512] text-white relative overflow-hidden" id="features">
          <div className="absolute w-[460px] h-[460px] rounded-full bg-[#17C97F] opacity-15 -top-28 -right-28 blur-[100px] pointer-events-none" />
          ...
          <div className="max-w-[1180px] mx-auto relative z-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              <div className="bg-[#0F1F19] border border-white/[0.08] rounded-2xl p-6 hover:bg-[#15342A] transition-colors">
                <div className="w-10 h-10 rounded-xl bg-[#17C97F]/15 border border-[#17C97F]/25 flex items-center justify-center mb-4 text-[#17C97F]">
                  <Clock className="w-5 h-5" />
                </div>
                <h3 className="font-bold text-base text-white mb-1.5">Real-Time Any Hour</h3>
              ...
              <div className="bg-[#0F1F19] border border-white/[0.08] rounded-2xl p-6 hover:bg-[#15342A] transition-colors">
                ...
                <h3 className="font-bold text-base text-white mb-1.5">Vet-Approved Protocols</h3>
                <p className="text-xs sm:text-sm text-[#9AB0A5] leading-relaxed">
              ...
              <div className="bg-[#0F1F19] border border-white/[0.08] rounded-2xl p-6 hover:bg-[#15342A] transition-colors">
                ...
                <h3 className="font-bold text-base text-white mb-1.5">Toxicity &amp; Hazard Checks</h3>
                <p className="text-xs sm:text-sm text-[#9AB0A5] leading-relaxed">
              ...
              <div className="bg-[#0F1F19] border border-white/[0.08] rounded-2xl p-6 hover:bg-[#15342A] transition-colors">
                ...
                <h3 className="font-bold text-base text-white mb-1.5">Sequential Action Steps</h3>
                <p className="text-xs sm:text-sm text-[#9AB0A5] leading-relaxed">
              ...
              <div className="bg-[#0F1F19] border border-white/[0.08] rounded-2xl p-6 hover:bg-[#15342A] transition-colors">
                ...
                <h3 className="font-bold text-base text-white mb-1.5">Emergency Clinic Routing</h3>
                <p className="text-xs sm:text-sm text-[#9AB0A5] leading-relaxed">
              ...
              <div className="bg-[#0F1F19] border border-white/[0.08] rounded-2xl p-6 hover:bg-[#15342A] transition-colors">
                ...
                <h3 className="font-bold text-base text-white mb-1.5">Talk or Type Naturally</h3>
                <p className="text-xs sm:text-sm text-[#9AB0A5] leading-relaxed">
        ...
        {/* Pricing Section */}
        <section className="py-20 sm:py-24 px-4 sm:px-8 bg-[#FBF7EC]" id="pricing">
          <div className="max-w-[1180px] mx-auto">
            <div className="max-w-[620px] mx-auto text-center mb-14">
              ...
              <h2 className="text-3xl sm:text-4xl font-display font-extrabold text-[#10201A] tracking-tight mb-2">
                Predictable plans for every pet family.
              </h2>
              <p className="text-[#4C5C53] text-sm sm:text-base">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-[920px] mx-auto items-stretch">
              {/* Basic Plan */}
              <div className="bg-white border border-[#E6DDC0] rounded-3xl p-8 sm:p-10 flex flex-col justify-between shadow-xs hover:-translate-y-1 transition-all">
                <div>
                  <h3 className="text-2xl font-bold text-[#10201A] mb-1">Just Sniffing It Out</h3>
                  <p className="text-xs sm:text-sm text-[#4C5C53] mb-6">
                    A starter pack for first-timers wanting quick veterinary guidance without recurring fees.
                  </p>
                  <div className="text-4xl sm:text-5xl font-display font-extrabold text-[#10201A] mb-1">
                    $5.99<span className="text-sm font-sans font-medium text-[#4C5C53]">/mo</span>
                  </div>
                  <p className="font-mono text-xs text-[#0E9C63] font-semibold mb-6">
                    10-minute starter consult pack
                  </p>

                  <ul className="space-y-3.5 text-xs sm:text-sm text-[#4C5C53] mb-8 border-t border-[#E6DDC0] pt-6">
                ...
                <button
                  ...
                  className="w-full py-3.5 rounded-full font-bold text-sm text-[#10201A] bg-[#F2EAD3] hover:bg-[#E6DDC0] transition-colors cursor-pointer"
                >
                  Join with Basic
                </button>
              </div>
              ...
              <div className="bg-[linear-gradient(165deg,#0F241D,#0A1712)] text-white border-2 border-[#17C97F] rounded-3xl p-8 sm:p-10 flex flex-col justify-between shadow-[0_24px_60px_-20px_rgba(23,201,127,0.3)] relative hover:-translate-y-1 transition-all">
                <span className="absolute -top-3.5 right-8 bg-gradient-to-r from-[#17C97F] to-[#0E9C63] text-[#06180F] font-mono text-xs font-bold px-4 py-1 rounded-full shadow-md">
                  Most Popular
                </span>

                <div>
                  <h3 className="text-2xl font-bold text-white mb-1">Pawblem Solver</h3>
                  <p className="text-xs sm:text-sm text-[#9AB0A5] mb-6">
                    Full peace of mind for dedicated pet parents who want answers always within reach.
                  </p>
                  <div className="text-4xl sm:text-5xl font-display font-extrabold bg-[linear-gradient(100deg,#fff,#9AE8C6)] bg-clip-text text-transparent mb-1">
                    $14.99<span className="text-sm font-sans font-medium text-[#9AB0A5]">/mo</span>
                  </div>
                  <p className="font-mono text-xs text-[#7DE8B8] font-semibold mb-6">
                    Includes 20 vet-trained minutes every month
                  </p>

                  <ul className="space-y-3.5 text-xs sm:text-sm text-[#D3E0D8] mb-8 border-t border-white/10 pt-6">
                    <li className="flex items-start gap-2.5">
                      <CheckCircle2 className="w-4 h-4 text-[#17C97F] flex-shrink-0 mt-0.5" />
                ...
                <button
                  ...
                  className="w-full py-3.5 rounded-full font-bold text-sm text-white bg-gradient-to-br from-[#FF6A4D] to-[#E24E30] shadow-[0_6px_20px_rgba(255,106,77,0.4)] hover:-translate-y-0.5 transition-all cursor-pointer"
                >
                  Join the Pack &rarr;
                </button>
              </div>
            ...
            <p className="text-center text-xs text-[#4C5C53] mt-8">
        ...
        {/* Founder Section */}
        <section className="py-20 sm:py-24 px-4 sm:px-8 bg-[#F2EAD3]/40 border-t border-[#E6DDC0]/70" id="founder">
          <div className="max-w-[1180px] mx-auto grid grid-cols-1 lg:grid-cols-[0.8fr_1.2fr] gap-12 items-start">
            <div className="bg-white rounded-3xl p-8 border border-[#E6DDC0] text-center shadow-xs lg:sticky lg:top-24">
              <div className="w-24 h-24 rounded-full mx-auto mb-4 bg-gradient-to-br from-[#17C97F] to-[#0E9C63] flex items-center justify-center text-[#06180F] font-bold text-2xl shadow-[0_8px_24px_rgba(23,201,127,0.3)]">
                AK
              </div>
              <h3 className="text-xl font-bold text-[#10201A]">Dr. Alexis Kole</h3>
              <div className="text-xs font-semibold text-[#0E9C63] mt-1 mb-4">
                DVM | Founder and Chief Veterinarian
              </div>
              <p className="text-xs text-[#4C5C53] leading-relaxed mb-6">
                Practicing veterinarian, lifelong animal advocate, and the clinical clinical force behind Vet365.AI.
              </p>
              <div className="flex justify-center gap-6 pt-5 border-t border-[#E6DDC0]">
                <div>
                  <b className="block text-xl font-bold text-[#10201A] font-display">7+</b>
                  <span className="text-[10.5px] uppercase font-mono text-[#4C5C53]">Years in Practice</span>
                </div>
                <div>
                  <b className="block text-xl font-bold text-[#10201A] font-display">1</b>
                  <span className="text-[10.5px] uppercase font-mono text-[#4C5C53]">AI Companion, Kora</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-display font-extrabold text-[#10201A] tracking-tight mb-5 leading-tight">
                "Communication is not just a clinical skill, it is the foundation of preventive medicine."
              </h2>

              <div className="space-y-4 text-sm sm:text-base text-[#4C5C53] leading-relaxed">
                <p>
                ...
                <blockquote className="font-display text-lg sm:text-xl font-medium text-[#10201A] pl-5 border-l-4 border-[#17C97F] my-5 italic">
        ...
        {/* FAQ Section */}
        <section className="py-20 sm:py-24 px-4 sm:px-8 bg-[#FBF7EC]" id="faq">
            ...
            <div className="space-y-3">
              {faqItems.map((item, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className="border border-[#E6DDC0] rounded-2xl bg-white overflow-hidden transition-all shadow-xs"
                  >
                    <button
                      type="button"
                      onClick={() => setOpenFaq(isOpen ? null : idx)}
                      className="w-full flex items-center justify-between p-5 text-left font-bold text-sm sm:text-base text-[#10201A] cursor-pointer gap-4"
                    >
                      <span>{item.q}</span>
                      <span
                    ...
                    {isOpen && (
                      <div className="px-5 pb-5 text-xs sm:text-sm text-[#4C5C53] leading-relaxed border-t border-[#E6DDC0]/40 pt-3 animate-modal-in">
                        {item.a}
                      </div>
                    )}
                  </div>
        ...
        {/* Final CTA */}
        <section className="bg-[radial-gradient(120%_140%_at_50%_20%,#16332A_0%,#0A1512_60%)] text-white text-center py-24 px-4 sm:px-8 relative overflow-hidden">
          <div className="absolute w-[600px] h-[600px] rounded-full bg-[#17C97F] opacity-15 -bottom-[260px] left-1/2 -translate-x-1/2 blur-[110px] pointer-events-none" />
          ...
          <div className="max-w-[640px] mx-auto relative z-10">
            ...
            <p className="text-[#9AB0A5] text-sm sm:text-base mb-8">
              Start with a single question, or get continuous monthly peace of mind. Kora is ready whenever you are.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <a
                href="#pricing"
                className="px-8 py-3.5 rounded-full font-bold text-sm text-white bg-gradient-to-br from-[#FF6A4D] to-[#E24E30] shadow-[0_10px_24px_rgba(255,106,77,0.35)] hover:-translate-y-0.5 transition-all flex items-center gap-2"
              >
                <span>Start Your First Consult</span>
                <ArrowRight className="w-4 h-4" />
              </a>
        ...
        {/* Footer */}
        <footer className="bg-[#081310] text-[#9AB0A5] pt-16 pb-8 px-4 sm:px-8 border-t border-white/[0.06]">
          <div className="max-w-[1180px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div>
              <h5 className="font-mono text-xs uppercase tracking-wider text-[#5E7166] font-bold mb-4">
                General
              </h5>
          ...
          <div className="max-w-[1180px] mx-auto pt-6 border-t border-[#1B2A22] flex flex-col sm:flex-row items-center justify-between text-xs text-[#5E7166] gap-3 text-center sm:text-left">
